...
func (b *backend) tidyPKI(ctx context.Context, req *logical.Request, bufferDuration time.Duration, tidyCertStore, tidyRevokedCerts, tidyRevocationList bool) error {
...
func (b *backend) pathTidyWrite(ctx context.Context, req *logical.Request, d *framework.FieldData) (*logical.Response, error) {
	...
	err := b.tidyPKI(ctx, req, safetyBuffer, tidyCertStore, tidyRevokedCerts, tidyRevocationList)
	if err != nil {
		return nil, err
	}
